...
class TestHelper():
    ...
    def verify_metric(self, spec_file: str, trace_proto_bytes: str, expected_output_file: str, metric_ids: list[str]):
        ...
        root_directory = parent(parent(parent(parent(parent(os.path.abspath(__file__))))))
        spec_file_path = os.path.join(root_directory, "metrics_v2", spec_file)
        expected_output_file_path = os.path.join(root_directory, "metrics_v2/tests/data", expected_output_file)

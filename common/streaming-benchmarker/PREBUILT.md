The APK in this prebuilt directory can be rebuilt by building the
Android project in tools/adt/idea/streaming/streaming-benchmarker.

In order to keep sizes small, please build the release target
